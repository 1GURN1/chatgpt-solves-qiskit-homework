...
- Trial ID: T04
- Assignment: HW2
- Synthetic student ID: `synth_hw2_trial_001`
- Deterministic seed: `132636380804824`
- Model name: 5.6 sol medium
- Date UTC: 2026-08-16
...
qiskit-aer package missing from environment during run of autograder. so needed to install.

non-palindromic input; reversed measurement map
